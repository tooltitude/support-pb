...
Tooltitude for Protobuf is a vscode extension providing various language services for Protobuf. It includes language server with formatter, navigation, code completion, find references for messages and enums. Also includes syntax highlighting, code snippets, and other features.
